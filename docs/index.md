# Reputation Visibility Matrix — Documentation

**Version:** 1.0.0  
**Author:** BuildYourReputation.online  
**Repository:** https://github.com/build-your-reputation-online/reputation-visibility-matrix  
...
Reputation Visibility Matrix is a digital reputation analysis framework from BuildYourReputation.online, created to help businesses, professionals, founders, and brands better understand their online visibility and reputation signals.
...
### Python CLI
```bash
reputation-matrix "brand-name" full-audit 88 82 85 78 90 84
```
...
|--------|-------------|-------------|
| Search Visibility | Branded search presence and ranking signals | 0–100 |
| Mention Score | Online mention volume and sentiment quality | 0–100 |
| Content Score | Published content presence and authority | 0–100 |
| Media Score | Media references and authoritative mentions | 0–100 |
| Review Score | Review signals across platforms | 0–100 |
| Digital Asset Score | Owned digital property completeness | 0–100 |
...
|----------|-----|
| Website | https://buildyourreputation.online |
| GitHub | https://github.com/build-your-reputation-online |
